...
public class Globals {
    ...
    public static double blueGoalX = 10; //7.5
    public static double blueGoalY = 137; //139.5
    public static double redGoalX = 140; //145.5
    public static double redGoalY = 137; //139.5
