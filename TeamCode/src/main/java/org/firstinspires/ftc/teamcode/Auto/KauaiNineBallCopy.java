...
//
//@Autonomous(name = "Kauai 15 Ball (pls work)", group = "A")
//public class KauaiNineBallCopy extends OpMode {
//
...
//    private final Pose prepPickupPoseBlue3 = new Pose(48, 40, Math.toRadians(180));
...
//
//    private PathChain startToScoreBlue, pickupBallsBlue1, scorePickupBlue1, pickupBallsBlue2, scorePickupBlue2, pickupBallsBlue3, scorePickupBlue3, pickupBallsBlue4, scorePickupBlue4, parkBlue;
//    private PathChain startToScoreRed, pickupBallsRed1, scorePickupRed1, pickupBallsRed2, scorePickupRed2, pickupBallsRed3, scorePickupRed3, pickupBallsRed4, scorePickupRed4, parkRed;
//
...
//                }
//                break;
//            case 11: // shooter up to speed, now shoot next 3 (12) balls
...
//                }
//                break;
//            case 12: // balls grabbed, now return to score
//                if(!follower.isBusy()) {
//                    runningActions.add(new InstantAction(() -> intake.intake()));
...
//                }
//                break;
//            case 14: // shooter up to speed, now shoot next 3 (15) balls
