...
@Autonomous(name = "15 + 3 FIELD 111111111111", group = "A", preselectTeleOp = "Odom TeleOp")
public class FifteenBallFar extends OpMode {
    ...
    private final Pose startPoseBlue = new Pose(57.35, 8, Math.toRadians(90)); // 2.375
    private final Pose partnerPushPoseBlue = new Pose(52, 8, Math.toRadians(90));
    // Spike 2
    ...
    // Open Gate + Grab
    private final Pose openGatePoseBlue = new Pose(14.6, 60.8, Math.toRadians(140));
